...
class ChatUser {
  ...
  handleMessage(jsonData) {
    ...
    else if (msg.type === "private-message") this.sendPrivateMessage(msg.text);
  ...
  async handleJoke() {
    ...
    let joke = {
      type: "chat",
      text: res.data.attachments[0].text,
      name: "Server",
    };
  ...
  sendPrivateMessage(text) {
    ...
    this.room.privateMessage(toUser, obj);
  }
